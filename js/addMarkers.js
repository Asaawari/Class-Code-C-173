    ...
    dishes.map(dish => {
      ...
      if (!dish.unavailable_days.includes(days[todaysDay])) {
        ...
        marker.appendChild(pricePlane);
         ...
         //Plane to show the feedback of the dish
         ...
         reviewPlane.setAttribute("geometry", {
            primitive: "plane", width: 1.5, height: 0.5
         })
